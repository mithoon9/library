    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control"name="memberId" value="" id="memId" placeholder="Member ID">
        </div>
        <div class="form-group">
          <label for="bookName">Book Name</label>
          <input type="text" class="form-control" name="bookName" value="" id="bookName" placeholder="Book Name">
        </div>
        <div class="form-group">
